...
// to be specific to you (name: 'your name', username: 'your username'), rather than my information.
  ...
  user1.name = "Andrew";
  user1.pwHash = "fake123@fake123.com";
...
// securityCode to make a Credit Card object and returns that object so that
...
*/
var bindCard = function(per, card){
  var bound = [];
    for(var key in per){
      bound[key] = bound[key];
    }
